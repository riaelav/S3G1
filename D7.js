...
function concatStrings(string1, string2) {
  ...
  let resultStrings = (firstString + secondString).toUpperCase();
  console.log(resultStrings);
}
concatStrings("Resisternonsipuò", "Alritmodeljazz");
...
*/
const stringLength = function (array) {
...
*/
const moviesNumber = function (movies) {
